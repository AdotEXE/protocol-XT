...
export const LANG = {
    ru: {
        ...
        minimize: "Свернуть",
        lobby: "ЛОББИ",
        openExtendedLobby: "Открыть расширенное лобби",
        expandCollapseChat: "Свернуть/Развернуть чат",
        profile: "ПРОФИЛЬ",
        login: "ВОЙТИ",
        register: "РЕГИСТРАЦИЯ",
        guest: "Гость",
        mapEditor: "РЕДАКТОР КАРТ",
        tankEditor: "МАСТЕРСКАЯ ТАНКОВ",
        resume: "ПРОДОЛЖИТЬ",
        restart: "ПЕРЕЗАГРУЗИТЬ",
        exitBattle: "ВЫЙТИ ИЗ БОЯ",
        welcomeChat: "Добро пожаловать в общий чат!",
