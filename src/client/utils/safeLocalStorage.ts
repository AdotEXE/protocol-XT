...
export const safeLocalStorage = {
    ...
    get(key: string, defaultValue: string = ''): string {
        try {
            ...
            console.warn(`[safeLocalStorage] Failed to get '${key}':`, e);
            return defaultValue;
        }
    },
        ...
        try {
            ...
            if (typeof defaultValue === 'object' && defaultValue !== null) {
                if (typeof parsed !== 'object' || parsed === null) {
                    console.warn(`[safeLocalStorage] Invalid JSON type for '${key}', using default`);
                    return defaultValue;
                }
            }
            return parsed as T;
        } catch (e) {
            console.warn(`[safeLocalStorage] Failed to parse JSON for '${key}':`, e);
            return defaultValue;
        }
    },
    ...
    setJSON<T>(key: string, value: T): boolean {
        try {
            ...
            console.warn(`[safeLocalStorage] Failed to set JSON for '${key}':`, e);
            return false;
        }
    },
    ...
    remove(key: string): boolean {
        try {
            ...
            console.warn(`[safeLocalStorage] Failed to remove '${key}':`, e);
            return false;
        }
    },
