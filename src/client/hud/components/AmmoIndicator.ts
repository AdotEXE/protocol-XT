...
export class AmmoIndicator {
    ...
    private create(): void {
        ...
        if (this.config.showAmmoType) {
            ...
            this.ammoTypeText.fontFamily = "Consolas, monospace";
        ...
        this.ammoText.fontFamily = "Consolas, monospace";
        ...
        if (this.config.showMagazine) {
            ...
            this.magazineText.fontFamily = "Consolas, monospace";
        ...
        this.reloadingText.fontFamily = "Consolas, monospace";
