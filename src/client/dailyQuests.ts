    ...
    private generateDailyQuests(): DailyQuest[] {
        ...
        const questTemplates = [
            ...
            },
            {
                id: "daily_pickups",
                name: "Снабженец",
                description: "Подобрать 5 припасов с земли",
                icon: "📦",
                requirement: 5,
                reward: { type: "currency" as const, amount: 80 },
                category: "exploration" as const
            },
            {
                id: "daily_critical",
                name: "Критические попадания",
                description: "Нанести 5 критических попаданий",
                icon: "🎯",
                requirement: 5,
                reward: { type: "experience" as const, amount: 120 },
                category: "combat" as const
            }
        ];
