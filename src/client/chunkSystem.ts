...
export class ChunkSystem {
    ...
    private createAllGarages(): void {
        ...
        if (this.config.mapType === "sand" || this.config.mapType === "tartaria" || this.config.mapType === "madness" || this.config.mapType === "expo" || this.config.mapType === "brest" || this.config.mapType === "arena") {
            logger.log(`[ChunkSystem] Skipping garage creation for map type: ${this.config.mapType}`);
            return;
        }
        ...
        logger.log(`[ChunkSystem] Filtered garage locations: ${garageLocations.length}/${allGarageLocations.length} within ${mapType} bounds`);
    ...
    private createGround(chunkX: number, chunkZ: number, cornerX: number, cornerZ: number, size: number, biome: BiomeType | string, _random: SeededRandom, chunkParent: TransformNode): void {
        ...
        if (this.config.mapType === "sandbox" || this.config.mapType === "sand" || this.config.mapType === "madness" || this.config.mapType === "expo" || this.config.mapType === "brest") {
    ...
    public logMemoryStats(): void {
        ...
        logger.log(`[ChunkSystem Memory] Materials: ${materialCount} (cached: ${cachedMaterialCount}), Meshes: ${meshCount}, Textures: ${textureCount}, Chunks: ${this.chunks.size}`);
    }
