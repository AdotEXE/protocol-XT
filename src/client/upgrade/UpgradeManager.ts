...
export class UpgradeManager {
    ...
    load(): void {
        try {
            ...
            console.error('[UpgradeManager] Failed to load:', e);
        }
    }
    ...
    save(): void {
        try {
            ...
            console.error('[UpgradeManager] Failed to save:', e);
        }
    }
    ...
    async syncToServer(): Promise<boolean> {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('[UpgradeManager] Synced to server');
                return true;
            }
        } catch (e) {
            ...
            if (response.ok) {
                ...
                if (data.upgrades) {
                    ...
                    if (serverTime > localTime) {
                        ...
                        this.save();
                        console.log('[UpgradeManager] Loaded from server');
                    }
                }
                return true;
            }
        } catch (e) {
            console.error('[UpgradeManager] Sync from server failed:', e);
        }
        return false;
    }
    ...
    reset(): void {
        this.upgrades = this.createDefaultUpgrades();
        this.save();
        console.log('[UpgradeManager] Reset to defaults');
    }
    ...
    addTestResources(): void {
        ...
        this.upgrades.playerLevel = getPlayerLevelFromXp(this.upgrades.totalXp);
        this.save();
        console.log('[UpgradeManager] Added test resources');
    }
}
