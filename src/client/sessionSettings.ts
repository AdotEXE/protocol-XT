...
export class SessionSettings {
    ...
    private createUI(): void {
        ...
        if (this.embedded) {
            logger.warn("[SessionSettings] createUI called in embedded mode, skipping overlay creation");
            return;
        }
    ...
    renderToContainer(container: HTMLElement): void {
        ...
        if (!this.embedded) {
            logger.warn("[SessionSettings] renderToContainer called but not in embedded mode");
        }
