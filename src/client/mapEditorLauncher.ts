...
export class MapEditorLauncher {
    ...
    show(): Promise<MapEditorLaunchResult> {
        return new Promise((resolve) => {
            ...
            logger.log("[MapEditorLauncher] Showing launcher modal...");
            this.createModal();
            ...
            setTimeout(() => {
                if (this.modal) {
                    ...
                    logger.log("[MapEditorLauncher] Modal state after creation:", {
    ...
    private createModal(): void {
        ...
        setTimeout(() => {
            if (this.modal) {
                ...
                logger.log("[MapEditorLauncher] Modal created and displayed", {
            ...
            confirmBtn.addEventListener("click", async () => {
                ...
                if (selectedAction === "new-empty") {
                    ...
                    try {
                        ...
                        logger.error("World Gen Error", e);
