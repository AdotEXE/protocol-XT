...
export class WorkshopUI {
    ...
    private initPreview(): void {
        ...
        if (!this.previewScene) {
            logger.error('[Workshop] Failed to initialize preview scene');
            return;
        }
    }
    ...
    private saveTank(): void {
        ...
        try {
            ...
            logger.log('[Workshop] Saved configuration:', config);
        } catch (e) {
            logger.error('[Workshop] Failed to save:', e);
    ...
    private testTank(): void {
        ...
        logger.log('[Workshop] Test tank saved:', config);
    }
