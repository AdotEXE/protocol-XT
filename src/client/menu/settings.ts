...
export interface GameSettings {
    ...
    shadows: boolean; // NEW: Enable/disable shadows entirely
    shadowQuality: number; // 0=low, 1=medium, 2=high
    ...
    autoReload: boolean;
    holdToAim: boolean;
    showTouchControls: boolean; // Экранное управление (джойстик)
...
export const DEFAULT_SETTINGS: GameSettings = {
    ...
    // Graphics
    particleQuality: 2,
    shadows: true, // NEW: Shadows enabled by default
    ...
    autoReload: false,
    holdToAim: false,
    showTouchControls: true, // Экранное управление включено по умолчанию
...
export function saveSettingsFromUI(): GameSettings {
    ...
    const settings: GameSettings = {
        ...
        shadows: getBool("set-shadows", true),
        ...
        showTouchControls: getBool("set-touch-controls", true),
...
export function applySettings(
    ...
    if (game && typeof game.applySettings === 'function') {
        ...
        game.applySettings();
        logger.log("[Settings] Applied via Game instance");
    }
