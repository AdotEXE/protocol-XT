...
export class ObserverRegistry {
    ...
    logStats(): void {
        ...
        logger.log(`[ObserverRegistry] Total: ${stats.total}`);
        logger.log(`[ObserverRegistry] By owner:`, Object.fromEntries(stats.byOwner));
        logger.log(`[ObserverRegistry] By type:`, Object.fromEntries(stats.byType));
    }
}
