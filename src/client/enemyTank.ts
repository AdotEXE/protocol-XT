...
export class EnemyTank {
    ...
    protected selectRandomModules(): ModuleType[] {
        ...
        if (availableModules.length === 0) {
            logger.warn(`[EnemyTank] WARNING: MODULE_PRESETS is empty!`);
            return [];
        }
    ...
    public updatePhysics(): void {
        ...
        if (this.barrel && this.barrel.isDisposed()) {
            ...
            logger.warn(`[EnemyTank ${this.id}] Barrel was disposed, recreating...`);
    ...
    private createDestructionAnimation(): void {
        ...
        for (const part of parts) {
            ...
            try {
                ...
                logger.error(`[EnemyTank] Failed to create destruction physics for ${part.name}:`, error);
            }
        }
