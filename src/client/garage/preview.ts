    ...
    const renderLoop = () => {
        ...
        try {
            ...
            if (msg.includes("program") || msg.includes("context") || msg.includes("Texture")) {
                console.warn("[Garage Preview] WebGL error suppressed:", msg);
                ...
                console.warn("[Garage Preview] Error in render loop:", e);
                isRunning = false;
            }
        }
    };
...
export function cleanupPreviewScene(previewScene: PreviewScene | null): void {
    ...
    try {
        console.log("[Garage Preview] Starting cleanup...");
        ...
        if (previewScene.scene && !previewScene.scene.isDisposed) {
            try {
                ...
                console.warn("[Garage Preview] Error disposing scene:", e);
            }
        }
        ...
        if (previewScene.engine && !previewScene.engine.isDisposed) {
            try {
                ...
                console.warn("[Garage Preview] Error disposing engine:", e);
            }
        }
        ...
        console.log("[Garage Preview] Cleanup complete");
        ...
        try {
            ...
            if (e instanceof Error && !e.message.includes("disposed")) {
                console.warn("[Garage Preview] Error clearing material cache:", e);
            }
        }
    }
}
