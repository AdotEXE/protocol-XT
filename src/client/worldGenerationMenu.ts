...
export class WorldGenerationMenu {
    ...
    private saveProfiles(): void {
        try {
            ...
            logger.warn("[WorldGenerationMenu] Failed to save profiles:", e);
        }
    }
    ...
    private loadProfiles(): void {
        try {
            ...
            logger.warn("[WorldGenerationMenu] Failed to load profiles:", e);
        }
    }
    ...
    private loadSettings(): void {
        try {
            ...
            logger.warn("[WorldGenerationMenu] Failed to load settings:", e);
        }
    }
    ...
    private setupEmbeddedEventListeners(container: HTMLElement): void {
        ...
        generateBtn?.addEventListener("click", () => {
            ...
            if (this.game && (this.game as any).generateWorld) {
                ...
                logger.log("[WorldGenerationMenu] World generation params:", { seed, size, biome, density });
                if (this.game?.hud) {
