...
export class HelpMenu {
    ...
    private categories: ControlCategory[] = [
        ...
        },
        {
            ...
            icon: "🛩",
            controls: [
                { key: "W / S", description: "Тяга (газ) больше/меньше" },
                { key: "A / D", description: "Крен влево/вправо" },
                { key: "Q / E", description: "Тангаж (нос вверх/вниз)" },
                { key: "МЫШЬ", description: "Прицел (куда лететь)" },
                { key: "SHIFT", description: "Свободный обзор камеры" },
            ]
        },
        {
            title: "ИНТЕРФЕЙС",
            ...
            controls: [
                ...
                { key: "J", description: "Панель миссий" },
