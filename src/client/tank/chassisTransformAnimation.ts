...
export class ChassisTransformAnimation {
    ...
    start(
        ...
        if (this.isRunning) {
            logger.warn("[ChassisTransform] Animation already running!");
            return;
        }
        ...
        logger.log(`[ChassisTransform] Starting transformation: ${oldChassisType.id} -> ${newChassisType.id}`);
    ...
    private finishAnimation(
        ...
        logger.log(`[ChassisTransform] Animation complete, creating new chassis: ${newChassisType.id}`);
