...
export function savePhysicsConfigToStorage(): void {
    try {
        ...
        logger.log("[PhysicsConfig] Saved to localStorage");
    } catch (e) {
        logger.error("[PhysicsConfig] Failed to save:", e);
    }
}
...
export function loadPhysicsConfigFromStorage(): boolean {
    try {
        ...
        logger.log("[PhysicsConfig] Loaded from localStorage");
        return true;
    } catch (e) {
        logger.error("[PhysicsConfig] Failed to load:", e);
        return false;
    }
}
