...
- **Mouse-Aim**: расстояние look-ahead, максимальный крен, ограничение угла атаки
...
- **Мышь**: определяет целевую точку в 3D пространстве
...
### Stall Warning
- Появляется при превышении критического угла атаки
