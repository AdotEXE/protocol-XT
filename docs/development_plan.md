...
### Фаза 3: Геймплей и Арт (Недели 11-16)
1.  Система вооружения (Hitscan, Projectiles).
2.  UI (React/HTML поверх Canvas).
3.  Интеграция Firebase (Auth, Firestore).
4.  WebGPU шейдеры и эффекты.
